...
"其它主题位置位于 $env:POSH_THEMES_PATH，请查看 $PROFILE 自行修改"
"另外，请在PowerShell或者CMD的设置中选择带有Nerd字样的字体。字体需要自行下载安装" 

 "安装MacOS Like的快速预览软件QuickLook"
scoop install QuickLook

 "安装除了程序员都需要的快速文件搜索软件Everything"
scoop install everything

 "安装磁盘空间占用管理工具TreeSize免费版"
